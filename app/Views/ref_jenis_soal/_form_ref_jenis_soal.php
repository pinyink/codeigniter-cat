<?= form_open_multipart($url, [], ['id' => $id, 'method' => $method]); ?>
	<div class="form-group">
		...
		<?= form_label('Nama Jenis Soal'); ?>
                    
		<?php $invalid = session('_ci_validation_errors.nama') ? 'is-invalid' : ''; ?>
                    
		<?php $value = isset($ref_jenis_soal['nama']) ? $ref_jenis_soal['nama'] : old('nama'); ?>
                    
		<div class="input-group">
                        
			<?= form_input('nama', trim($value), ['class' => 'form-control '.$invalid, 'placeholder' => 'Nama Jenis Soal']); ?>
