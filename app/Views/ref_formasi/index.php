...
<div class="page-heading">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ref Formasi</li>
    </ol>
</div>
...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12">
            ...
            <div class="ibox">
                <div class="ibox-body">
                    <?php if(enforce(4, 2)): ?>
                        <a href='<?=base_url('ref_formasi/tambah')?>' class='btn btn-info btn-sm'><i class="fa fa-plush"></i> Tambah Data</a>
                    <?php endif ?>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Data Ref Formasi</div>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#datatable').DataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo base_url('ref_formasi/ajax_list') ?>",
                        "headers": {
    ...
    function delete_data(id) {
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "DELETE",
                url: "<?=base_url('ref_formasi')?>/"+id+'/delete',
                data: {'<?=csrf_token()?>' : '<?=csrf_hash()?>'},
                dataType: "json",
