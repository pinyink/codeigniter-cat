...
<div class="page-content fade-in-up">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            ...
            <div class="ibox">
                <div class="ibox-body">
                    ...
                    <?php if(enforce(4, 3)): ?>
                        <a href='<?=base_url('ref_formasi/'.$ref_formasi['id'].'/edit')?>' class='btn btn-primary btn-sm'><i class="fa fa-edit"></i> Edit Data</a>
                    <?php endif ?>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Detail Ref Formasi</div>
                ...
                <div class="ibox-body">
                    <div class="row">
                        <div class="col-md-12">
                            <?= $this->include('ref_formasi/_detail'); ?>
                        </div>
                    </div>
                </div>
            </div>
