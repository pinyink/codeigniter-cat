...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12">
            ...
            <div class="ibox">
                <div class="ibox-body">
                    <?php if(enforce(3, 2)): ?>
                        <a href='<?=base_url('images/tambah')?>' class='btn btn-info btn-sm'><i class="fa fa-plush"></i> Tambah Data</a>
                    <?php endif ?>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Data Images</div>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#datatable').DataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo base_url('images/ajax_list') ?>",
                        "headers": {
