...
<div class="page-heading">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ref Soal</li>
    </ol>
</div>
...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12">
            ...
            <div class="ibox">
                <div class="ibox-body">
                    <?php if(enforce(2, 2)): ?>
                        <a href='<?=base_url('ref_soal/tambah')?>' class='btn btn-info btn-sm'><i class="fa fa-plush"></i> Tambah Data</a>
                    <?php endif ?>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Data Ref Soal</div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th width="15%">Aksi</th>
                                    <th width="10%">No</th>
									<th style="width: 37.5%">Jenis Soal</th>
									<th style="width: 37.5%">Soal</th>
                                </tr>
                            </thead>
                            <tbody>
...
<script>
    ...
    $(document).ready(function () {
        table = $('#datatable').DataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo base_url('ref_soal/ajax_list') ?>",
                        "headers": {
    ...
    function delete_data(id) {
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "DELETE",
                url: "<?=base_url('ref_soal')?>/"+id+'/delete',
                data: {'<?=csrf_token()?>' : '<?=csrf_hash()?>'},
                dataType: "json",
